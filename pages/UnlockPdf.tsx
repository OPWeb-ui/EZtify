...
import { UnlockKeyhole, Unlock, RefreshCw, FileText, X, Eye, EyeOff, Zap, Cpu, ShieldCheck, Lock } from 'lucide-react';
...
export const UnlockPdfPage: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-slate-50 dark:bg-charcoal-950">
      <PageReadyTracker />
      <motion.div
        key="studio"
        initial={{ opacity: 0 }}
          ...
          <div className="p-8 md:p-12 flex flex-col items-center">
              ...
              {isEncrypted ? (
                ...
                <div className="text-center w-full max-w-md">
                    ...
                    <p className="text-sm text-charcoal-500 dark:text-charcoal-400 mb-6">This file is already accessible.</p>
