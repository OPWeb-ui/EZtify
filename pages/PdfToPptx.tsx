...
import { Presentation, CheckCircle, RefreshCw, Zap, Lock, Cpu, Settings, Loader2, Download, X } from 'lucide-react';
        ...
        {!file ? (
          <ToolLandingLayout
            ...
            specs={[
              ...
              { label: "Layout", value: "16:9", icon: <Settings /> },
            ]}
            tip="Each PDF page is converted into a high-quality image slide in the presentation."
          />
        ) : (
          <motion.div
            key="studio"
             ...
             <div className="w-full max-w-2xl bg-white dark:bg-charcoal-900 rounded-2xl border border-slate-200 dark:border-charcoal-700 shadow-2xl overflow-hidden relative ring-1 ring-black/5">
                ...
                <div className="h-10 bg-slate-50 dark:bg-charcoal-850 border-b border-slate-200 dark:border-charcoal-700 flex items-center justify-between px-4 select-none">
                   <div className="flex gap-3 items-center">
                      ...
                      <span className="text-[10px] font-mono uppercase tracking-widest text-charcoal-500 dark:text-charcoal-400 font-bold">PDF_TO_PPTX</span>
                   </div>
                ...
                <div className="p-12 flex flex-col items-center text-center">
                    ...
                    <p className="text-xs font-mono text-charcoal-500 dark:text-slate-400 mb-8 uppercase tracking-wide">
                       {(file.size / 1024).toFixed(1)} KB • {result ? "PPTX READY" : "PDF LOADED"}
                    </p>
                    ...
                    <div className="w-full max-w-sm space-y-3">
                        {!result ? (
                           ...
                           >
                              {isGenerating ? (
                                 <>
                                    ...
                                    <span>RASTERIZING... {progress}%</span>
                                 </>
                              ) : (
                                 <>
                           ...
                           <>
                              ...
                              >
                                 <Download size={16} /> DOWNLOAD_PPTX
                              </motion.button>
                              <motion.button
                                onClick={reset}
                                whileTap={buttonTap}
