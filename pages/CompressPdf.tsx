...
import { Download, FileText, Settings, RefreshCw, Loader2, Minimize2, FilePlus, Cpu, Lock, Zap, X } from 'lucide-react';
...
export const CompressPdfPage: React.FC = () => {
  ...
  const processDroppedFiles = useCallback((acceptedFiles: File[]) => {
    if (isProcessingFiles || processingId) return;
  ...
  }, [addToast, isProcessingFiles, processingId]);
          ...
          <AnimatePresence>
              {isDragActive && (
                  ...
                  >
                      ...
                      <h3 className="text-2xl font-mono font-bold">DROP_TO_ADD</h3>
                  </motion.div>
              )}
          </AnimatePresence>
              ...
              <div className="space-y-3 mt-auto pt-4 border-t border-slate-200 dark:border-charcoal-700 md:border-none md:pt-0">
                  ...
                  >
                      ...
                      <div className="relative flex items-center justify-center gap-2 z-10 uppercase tracking-wide">
                          ...
                          <span>{!!processingId ? 'COMPRESSING...' : 'EXECUTE_COMPRESS'}</span>
                      </div>
                  </motion.button>
