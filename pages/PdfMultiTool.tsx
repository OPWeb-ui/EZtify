...
import { 
  ...
  FileArchive, Loader2, MousePointer2, GripHorizontal, Plus
} from 'lucide-react';
import {
...
export const PdfMultiToolPage: React.FC = () => {
  ...
  const { getRootProps } = useDropzone({ onDrop, accept: { 'application/pdf': ['.pdf'] }, noClick: true, noKeyboard: true });
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-charcoal-900 overflow-hidden" {...getRootProps()}>
      <PageReadyTracker />
