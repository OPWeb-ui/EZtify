...
import { 
  ...
  Cpu, Info, Settings, Zap, FolderArchive, ShieldCheck
} from 'lucide-react';
...
export const ZipFilesPage: React.FC = () => {
  ...
  // Hook for the "Add More" functionality in the list view
                ...
                <div className="w-full md:w-80 bg-white dark:bg-charcoal-900 border-t md:border-t-0 md:border-l border-slate-200 dark:border-charcoal-700 p-6 flex flex-col gap-6 shrink-0 relative z-20">
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar">
                        ...
                        <div className="bg-slate-50 dark:bg-charcoal-800 rounded-xl p-4 border border-slate-200 dark:border-charcoal-700 space-y-3">
                            ...
                            <div className="flex justify-between items-center text-xs">
                                <span className="text-charcoal-600 dark:text-charcoal-400 font-mono">Algorithm</span>
                                <span className="font-bold text-charcoal-900 dark:text-white font-mono text-[10px] bg-white dark:bg-charcoal-900 px-2 py-0.5 rounded border border-slate-200 dark:border-charcoal-600">DEFLATE</span>
                            </div>
                        </div>
                    </div>
