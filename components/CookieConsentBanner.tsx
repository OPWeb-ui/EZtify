    ...
    >
      <div className="max-w-4xl mx-auto p-4 rounded-2xl bg-white/95 dark:bg-charcoal-900/95 backdrop-blur-xl border border-slate-200 dark:border-charcoal-700 shadow-2xl shadow-brand-purple/10 flex flex-col md:flex-row items-center gap-4 pointer-events-auto">
        ...
        <div className="flex-1 flex items-center gap-3">
          ...
          <p className="text-xs md:text-sm text-charcoal-600 dark:text-slate-300 leading-relaxed">
        ...
        <div className="flex-shrink-0 flex items-center gap-2">
          <motion.button
            whileTap={buttonTap}
            onClick={onReject}
            className="px-4 py-2 text-charcoal-500 dark:text-slate-400 text-xs font-medium rounded-lg hover:bg-slate-100 dark:hover:bg-charcoal-800 transition-colors"
          >
            Reject
          </motion.button>
          <motion.button
            whileTap={buttonTap}
            onClick={onAccept}
            className="px-4 py-2 bg-brand-purple text-white text-xs font-bold rounded-lg shadow-md shadow-brand-purple/20 hover:bg-brand-purpleDark transition-colors"
          >
            Accept
          </motion.button>
        </div>
